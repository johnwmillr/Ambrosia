...
descriptions = ['baked', 'beaten', 'blanched', 'boiled', 'boiling', 'boned', 'breaded', 'brewed', 'broken', 'canned',
                'chilled',
                ...
                'unsalted',
                'russet', 'country', 'navel', 'halved', 'pitted', 'extra', 'xtra', 'pound', 'head', 'savoy',
                'crosswise', 'plus', 'white',
                'peeled', 'teaspoon', 'teaspoons', 'whole', 'cans', 'size', 'to', 'blend', 'low', 'sodium', 'pure',
                'dark',
                'natural', 'husked', 'a', 'handful',
                'of', 'unrefined', 'granulated', 'assorted', 'additional', 'pack', 'vaccum', 'tablespoon',
                'tablespoons',
                'taste', 'then', 'but', 'not', 'saga', 'diameter', 'horizontally', 'portobello', 'grained', 'raw',
                'unsweetened', 'superfine', 'each', 'cubes', 'crustless', 'mixed', 'excess', 'of', 'semisweet', 'mild',
                'flavored',
                'rind', 'pith', 'free', 'more', 'golden', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'one',
                'two', 'three', 'four',
                'five', 'six', 'seven', 'eight', 'nine', 'zero', 'by', 'no', 'boil', 'no', 'hulled', 'yellow',
                'packages', 'petite'
                            'diameter', 'cracked', 'sweet', 'greek', 'well', 'shaken', 'organic', 'homemade', 'left',
                'peeled', 'unpeeled',
                'pink', 'extremely', 'available', 'shoulder', 'center','from','fast','acting','active','reserving','greens',
				'separately','bing','sharp','purchased','wide','souffl','lengthwise','fat','powdered']
...
unnecessaryDescriptions = ['chunks', 'pieces', 'rings', 'spears', 'all purpose', 'all-purpose']
...
def getIngredients(ingredientObjects):
    unlabeledIngredients = set()

    # ingredientObjects = [u'4 cups low-sodium vegetable or chicken stock', u'1 cup dried brown lentils', u'1/2 cup dried French green lentils', u'2 stalks celery, chopped', u'1 large carrot, peeled and chopped', u'1 sprig fresh thyme', u'1 teaspoon kosher salt', u'1 medium tomato, cored, seeded, and diced', u'1 small Fuji apple, cored and diced', u'1 tablespoon freshly squeezed lemon juice', u'2 teaspoons extra-virgin olive oil', u'Freshly ground black pepper to taste', u'3 sheets whole-wheat lavash, cut in half crosswise, or 6 (12-inch) flour tortillas', u'3/4 pound turkey breast, thinly sliced', u'1/2 head Bibb lettuce']
    ingredientObjects = [i.encode('ascii', 'ignore').lower() for i in ingredientObjects]
